...
#     fav_rests = db.relationship("Restaurant", secondary="fav_rests", back_populates="fav_users")
...
#     fav_users = db.relationship("User", secondary="fav_rests", back_populates="fav_rests")
